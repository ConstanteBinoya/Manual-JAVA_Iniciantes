package curso_java._J_arrays_vetores._C_exercicios_arrays._C_exercicio3_alturas.application;

import curso_java._J_arrays_vetores._C_exercicios_arrays._C_exercicio3_alturas.entities.Pessoa;
...
public class CalculadorMedias {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < pessoas.length; i++) {
            ...
            /*
            sc.nextLine(); consome o caractere de quebra de linha deixado pelo nextInt()
            anterior, evitando que nextLine() pule a entrada."
             */
            sc.nextLine();
