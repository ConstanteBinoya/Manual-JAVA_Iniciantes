package curso_java._I_POO_ProgramacaoOrientadaObjetos._B_encapsulamento._C_getters_setters._B_cinema2.application;

import curso_java._I_POO_ProgramacaoOrientadaObjetos._B_encapsulamento._C_getters_setters._B_cinema2.entities.Ingresso2;

import java.util.Locale;
import java.util.Scanner;

public class CinemaIngresso2 {
    public static void main(String[] args) {
        ...
        Ingresso2 ingresso = new Ingresso2(nomeFilme, horario);
