package curso_java._I_POO_ProgramacaoOrientadaObjetos._B_encapsulamento._A_construtores._A_estoque1.application;

import curso_java._I_POO_ProgramacaoOrientadaObjetos._B_encapsulamento._A_construtores._A_estoque1.entities.Product1;

import java.util.Locale;
import java.util.Scanner;

public class ControleEstoque1 {
    public static void main(String[] args) {
         ...
         */
        Product1 product1 = new Product1(name, price, initialQuantity);
